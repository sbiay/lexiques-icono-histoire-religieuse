---
title: Ressources documentaires en histoire de l'art médiéval
...
- Lien : [opac.regesta-imperii.de](https://opac.regesta-imperii.de/)
- Caractéristiques : très complet, notamment pour l'histoire de la civilisation médiévale au sens large, mais indexation thématique pauvre
...
- Type d'accès : libre et gratuit
- Lien : [kubikat.org](https://www.kubikat.org/)
